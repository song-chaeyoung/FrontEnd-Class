...
console.log(addNum(1, 8, 5, 7, 9, 10, 29));
...
// 4) 구조분해할당, 전개연산자 구문
let [teacher, ...sudents] = ["Kim", "Lee", "Park", "Choi"];
console.log(teacher, sudents);
...
// 객체 선언 시, key 네이밍 === value값으로 할당하고자 하는 매개변수의 이름이 동일하다면
...
// 5. 배열 메서드
// map // filter / reduce
// map : 배열안에 있는 아이템(*요소)들에게 동일한 특정 함수 안에 있는 기능을 동일하게 실행, 적용 => 새로운 배열로 다시 생성
